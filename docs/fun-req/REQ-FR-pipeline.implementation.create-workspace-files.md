...
**Источник:** [UC-pipeline.implementation.execute-change-in-isolation](../use-cases/UC-pipeline.implementation.execute-change-in-isolation.md), BR-constraint.automation.workspace-tool-capability
