...
> **Методологическая база:** `README.md` §4.3, §5, §8; `gates.md` (`FG-BUILD`, `FG-UNIT`, `FG-REGRESSION`); `vision.md` (функции HF1–HF12, ограничения §2.6); `use-cases/`, `business-rules/`, `contracts/`, `c4/`; `.ai-factory/references/software-requirements-wiegers-beatty.md`.
...
- [Фитнес-функции](../.ai-factory/references/fitness-functions.md) — метрики и пороги
