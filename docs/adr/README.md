...
> **Статус:** на уровне требований зафиксировано: видение продукта — `docs/vision.md`; архитектура — `docs/architecture.md`, `.ai-factory/ARCHITECTURE.md`; C4-модель — если есть, в `docs/c4/`; глоссарий — `docs/glossary.md`. ADR в этой директории зафиксированы по фактической реализации (as-is) — см. [реестр](#реестр-adr-проекта) ниже. Подсистема сбора и AI-анализа телеметрии спроектирована и пока не реализована — её решения внесены в реестр со статусом **ПРЕДЛОЖЕНО** и описаны в [`docs/telemetry.md`](../telemetry.md).
...
| `ADR-DES.OPS.otel-collector-adoption`            | OpenTelemetry + OTel Collector: единый стандарт и точка политик для всех сигналов всех процессов  | ПРЕДЛОЖЕНО | 2026-09-18 |
| `ADR-DES.OPS.grafana-backend-stack`              | Self-hosted Tempo + Loki + Prometheus + Grafana; metrics через scrape Collector                   | ПРЕДЛОЖЕНО | 2026-09-18 |
| `ADR-DES.OPS.telemetry-schema-contract`          | Единый контракт: resource-атрибуты, semconv-first + `aif.*`, cardinality policy                   | ПРЕДЛОЖЕНО | 2026-09-18 |
| `ADR-DES.OPS.pino-otel-log-bridge`               | pino остаётся источником логов; доставка в Loki — аддитивный OTLP-мост с trace context            | ПРЕДЛОЖЕНО | 2026-09-18 |
| `ADR-DES.PROCESS.manual-seam-instrumentation`    | Ручная instrumentация на существующих швах; порт телеметрии в `@aif/runtime` без OTel-зависимости | ПРЕДЛОЖЕНО | 2026-09-18 |
| `ADR-DES.PROCESS.correlation-first-async-traces` | Трасса на прогон стадии + span links + логическая трасса задачи; контент — opt-in                 | ПРЕДЛОЖЕНО | 2026-09-18 |
...
| `ADR-DES.API.data-access-boundary`               | [BR-constraint.audit.immutable-trail](../business-rules/BR-constraint.audit.immutable-trail.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `ADR-DES.API.runtime-adapter-pattern`            | [BR-fact.project.runtime-profiles](../business-rules/BR-fact.project.runtime-profiles.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `ADR-IMPL.PROCESS.task-state-machine`            | [BR-fact.task-lifecycle.stages](../business-rules/BR-fact.task-lifecycle.stages.md), [BR-constraint.task-lifecycle.transitions](../business-rules/BR-constraint.task-lifecycle.transitions.md), [BR-trigger.task-lifecycle.blocked](../business-rules/BR-trigger.task-lifecycle.blocked.md)                                                                                                                                                                                                                                                           |
| `ADR-DES.API.hono-websocket-adoption`            | [BR-fact.audit.observability](../business-rules/BR-fact.audit.observability.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `ADR-IMPL.UI.react-vite-tailwind-adoption`       | Бизнес-правила не затрагивает (UI-стек)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `ADR-IMPL.DATA.sqlite-drizzle-adoption`          | [BR-constraint.audit.immutable-trail](../business-rules/BR-constraint.audit.immutable-trail.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `ADR-IMPL.DATA.migration-append-only`            | Бизнес-правила не затрагивает (эксплуатация схемы)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `ADR-IMPL.INFRA.worktree-parallel-execution`     | [BR-constraint.git.worktree-isolation](../business-rules/BR-constraint.git.worktree-isolation.md), [BR-constraint.automation.concurrency](../business-rules/BR-constraint.automation.concurrency.md)                                                                                                                                                                                                                                                                                                                                                  |
| `ADR-DES.SECURITY.auth-session-model`            | [BR-fact.auth.roles](../business-rules/BR-fact.auth.roles.md), [BR-constraint.auth.credentials](../business-rules/BR-constraint.auth.credentials.md), [BR-constraint.auth.sessions](../business-rules/BR-constraint.auth.sessions.md)                                                                                                                                                                                                                                                                                                                 |
| `ADR-DES.INTEGRATION.github-gitlab-vcs-workflow` | [BR-fact.git.vcs-workflow](../business-rules/BR-fact.git.vcs-workflow.md), [BR-trigger.automation.plan-review-gate](../business-rules/BR-trigger.automation.plan-review-gate.md)                                                                                                                                                                                                                                                                                                                                                                      |
| `ADR-IMPL.PROCESS.auto-queue-advancement`        | [BR-trigger.automation.auto-queue](../business-rules/BR-trigger.automation.auto-queue.md), [BR-trigger.automation.completion-commit](../business-rules/BR-trigger.automation.completion-commit.md)                                                                                                                                                                                                                                                                                                                                                    |
| `ADR-IMPL.PROCESS.coordinator-pipeline-pattern`  | [BR-trigger.automation.pipeline](../business-rules/BR-trigger.automation.pipeline.md), [BR-trigger.automation.failure-recovery](../business-rules/BR-trigger.automation.failure-recovery.md), [BR-fact.ownership.assignment](../business-rules/BR-fact.ownership.assignment.md)                                                                                                                                                                                                                                                                       |
| `ADR-DES.OPS.otel-collector-adoption`            | [BR-fact.audit.observability](../business-rules/BR-fact.audit.observability.md), [BR-fact.audit.otel-telemetry-backbone](../business-rules/BR-fact.audit.otel-telemetry-backbone.md)                                                                                                                                                                                                                                                                                                                                                                  |
| `ADR-DES.OPS.grafana-backend-stack`              | [BR-fact.audit.observability](../business-rules/BR-fact.audit.observability.md), [BR-fact.audit.otel-telemetry-backbone](../business-rules/BR-fact.audit.otel-telemetry-backbone.md)                                                                                                                                                                                                                                                                                                                                                                  |
| `ADR-DES.OPS.telemetry-schema-contract`          | [BR-fact.audit.observability](../business-rules/BR-fact.audit.observability.md), [BR-constraint.audit.immutable-trail](../business-rules/BR-constraint.audit.immutable-trail.md), [BR-constraint.audit.telemetry-correlation-contract](../business-rules/BR-constraint.audit.telemetry-correlation-contract.md)                                                                                                                                                                                                                                       |
| `ADR-DES.OPS.pino-otel-log-bridge`               | [BR-fact.audit.observability](../business-rules/BR-fact.audit.observability.md), [BR-fact.audit.otel-telemetry-backbone](../business-rules/BR-fact.audit.otel-telemetry-backbone.md), [REQ-NFR-ops.observability.log-level-config](../nonfun-req/REQ-NFR-ops.observability.log-level-config.md)                                                                                                                                                                                                                                                       |
| `ADR-DES.PROCESS.manual-seam-instrumentation`    | [BR-fact.audit.observability](../business-rules/BR-fact.audit.observability.md), [BR-fact.project.runtime-profiles](../business-rules/BR-fact.project.runtime-profiles.md)                                                                                                                                                                                                                                                                                                                                                                            |
| `ADR-DES.PROCESS.correlation-first-async-traces` | [BR-fact.audit.observability](../business-rules/BR-fact.audit.observability.md), [BR-constraint.audit.immutable-trail](../business-rules/BR-constraint.audit.immutable-trail.md), [BR-constraint.ownership.executor-history](../business-rules/BR-constraint.ownership.executor-history.md), [BR-constraint.audit.telemetry-content-minimality](../business-rules/BR-constraint.audit.telemetry-content-minimality.md), [BR-constraint.audit.telemetry-correlation-contract](../business-rules/BR-constraint.audit.telemetry-correlation-contract.md) |
...
- [Архитектура телеметрии](../telemetry.md) — концепция подсистемы сбора и AI-анализа телеметрии
