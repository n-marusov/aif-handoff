...
| `AIF_AGENT_DEFINITIONS_DIR`                            | string  | `<cwd>/.claude/agents`         | Directory from which the agent reads scope rules (project/review) out of `.claude/agents/plan-coordinator.md`. Override for container/absent-cwd deployments; defaults to the process working directory                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
