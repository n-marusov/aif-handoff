...
function makeEnv(overrides: Record<string, unknown> = {}) {
  return {
    ...
    AGENT_ACTIVITY_SILENCE_MS: 300000,
    ...
    PARTICIPANT_SESSION_TTL_SECONDS: 7 * 24 * 60 * 60,
    ...
    COORDINATOR_MAX_CONCURRENT_TASKS_PER_PROJECT: 1,
