...
- [ ] **Unified OTel Telemetry (proposed)** — OpenTelemetry collection across all processes into Tempo/Loki/Prometheus with a collector policy point and an AI analysis contour; see `docs/telemetry.md` and `docs/vision.md` §2.5 (Phase 5).
